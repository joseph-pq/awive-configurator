...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--wlcrop", action="store_true", help="Water level crop")
    parser.add_argument("-b", "--blur", action="store_true", help="Blur image")
    parser.add_argument(
        "-z", "--resize", action="store_true", help="Resizer image to 1000x1000"
    )
    parser.add_argument(
        "-t", "--time", default=1, type=int, help="Time delay between each frame (ms)"
    )
